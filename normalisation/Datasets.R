...
exp.bsgs.lcl  <- QuantileNormalise(exp.bsgs)
...
exp.bsgs.pbmc <- QuantileNormalise(exp.bsgs)
exp.bsgs.pbmc <- CorrectByPca(exp.bsgs.lcl, n.pcs = 25)
exp.bsgs.lcl  <- t(apply(exp.bsgs.lcl, 1, InverseNormalTransform))
#-------------------------------------------------------------------------------
# CAD
#-------------------------------------------------------------------------------
exp.cad.1 <- read.table(file.path(inpath, "CAD/clean/CAD_exp_phase1.txt"), header = TRUE, sep = "\t")
exp.cad.1 <- LogNormalise(exp.cad.1, neg.rm = TRUE, row.names = TRUE)
exp.cad.1 <- QuantileNormalise(exp.cad.1)
exp.cad.1 <- CorrectByPcs(exp.cad.1, n.pcs = 25)
...
exp.cad.2 <- LogNormalise(exp.cad.2, neg.rm = TRUE, row.names = TRUE)
exp.cad.2 <- QuantileNormalise(exp.cad.2)
exp.cad.2 <- CorrectByPcs(exp.cad.2, n.pcs = 25)
...
exp.chdwb <- CorrectByPcs(exp.chdwb, n.pcs = 25)
...
exp.egcut <- CorrectByPcs(exp.egcut, n.pcs = 25)
...
exp.moroc <- CorrectByPcs(exp.moroc, n.pcs = 25)
...
exp.mut.fat <- CorrectByPcs(exp.mut.fat, n.pcs = 25)
...
exp.mut.skin <- CorrectByPcs(exp.mut.skin, n.pcs = 25)
...
exp.mut.lcl <- CorrectByPcs(exp.mut.lcl, n.pcs = 25)
